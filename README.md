![@swenkerorg/temporibus-impedit](https://raw.github.com/cainus/@swenkerorg/temporibus-impedit/master/@swenkerorg/temporibus-impedit.png "@swenkerorg/temporibus-impedit")


[![Build Status](https://travis-ci.org/cainus/@swenkerorg/temporibus-impedit.png?branch=master)](https://travis-ci.org/cainus/@swenkerorg/temporibus-impedit)
[![Coverage Status](https://coveralls.io/repos/cainus/@swenkerorg/temporibus-impedit/badge.png?branch=master)](https://coveralls.io/r/cainus/@swenkerorg/temporibus-impedit)
[![NPM version](https://badge.fury.io/js/@swenkerorg/temporibus-impedit.png)](http://badge.fury.io/js/@swenkerorg/temporibus-impedit)

[![browser support](https://ci.testling.com/cainus/@swenkerorg/temporibus-impedit.png)](http://ci.testling.com/cainus/@swenkerorg/temporibus-impedit)
...
To create a new @swenkerorg/temporibus-impedit object, just pass a url to @swenkerorg/temporibus-impedit like so:
```javascript
var url = @swenkerorg/temporibus-impedit("https://user:pass@subdomain.asdf.com/path/kid?asdf=1234#frag")
```
...
## Installation:
### node.js:
`npm install @swenkerorg/temporibus-impedit --save`

Also!  If you're using @swenkerorg/temporibus-impedit in an http application, see [@swenkerorg/temporibus-impedit-connect](https://github.com/swenkerorg/temporibus-impedit-connect).  It gives you an @swenkerorg/temporibus-impedit object already instantiated with the request url as req.uri in all your request handlers.
